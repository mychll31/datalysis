...
import NavBar from "../Components/Navbar/homenav"; // Import NavBar correctly
  ...
  return (
    <div className={`transition-colors duration-300 ${darkMode ? "dark" : ""}`}>
      ...
      <div className="flex flex-row justify-center bg-gray-100 dark:bg-gray-800">
        <a href="https://www.facebook.com/valenin.it.services" className="mx-40">
          <div className="px-48 py-16 bg-valenin bg-contain bg-no-repeat bg-center"></div>
        </a>
        <a href="https://www.facebook.com/gencysecommercesolutions" className="mx-40">
          <div className="px-48 py-16 bg-gencys bg-contain bg-no-repeat bg-center"></div>
        </a>
      </div>
