...
import { LineChartComponent } from "../Components/Line"; // NEW IMPORT
    ...
    <section className="bg-displayBg bg-no-repeat bg-cover bg-bottom w-full min-h-screen flex flex-col items-center">
      ...
      {charts.map((chart, index) => (
        <div key={index} className="w-full pb-10 flex flex-col items-center">
            ...
            <>
              ...
              chart.data.column_stats[chart.targetColumn2]?.type ===
                ...
                <div className="text-red-500 text-center my-4">
                  Error: Both selected columns cannot be categorical. Please
                  choose at least one numeric column for relationship analysis.
                </div>
              ) : (
                <div className="w-1/2">
                  <div className="App bg-white border-gray-900 border-8 shadow-xl p-4 rounded-lg">
          ...
          {chart.type === "line" && chart.data?.plot_data && (
            <div className="w-1/2">
              <div className="App bg-white border-gray-900 border-8 shadow-xl p-4 rounded-lg">
                <LineChartComponent
                  data={chart.data.plot_data}
                  xKey={chart.targetColumn1}
                  yKey={chart.targetColumn2}
                  title={`Line Chart: ${chart.targetColumn1} vs ${chart.targetColumn2}`}
                />
              </div>
            </div>
          )}
          ...
          {index === charts.length - 1 && (
            <>
              <h2 className="w-1/2 text-center text-lg text-gray-400 font-light mt-10">
                Statistics Summary
              </h2>
