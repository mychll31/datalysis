...
const Profile = () => {
    ...
    const [profileImage, setProfileImage] = useState(() => {
        ...
        return savedImage || "https://via.placeholder.com/40";
    });
        ...
        for (let i = 0; i < files.length; i++) {
            ...
            reader.onloadend = () => {
                ...
                if (file.type === "application/pdf") {
                    ...
                    fileData = { type: "pdf", content: blobUrl };
                } else {
                    fileData = { type: "image", content: reader.result };
                }

                setUploadedCharts((prevCharts) => {
                    const updatedCharts = [...prevCharts, fileData];
                    localStorage.setItem("uploadedCharts", JSON.stringify(updatedCharts));
            ...
            if (file.type === "image/png") {
                ...
                reader.readAsArrayBuffer(file); // Important for PDF Blob
            } else {
                            ...
                            <section className="min-h-[60vh] bg-gray-100 dark:bg-gray-900 mt-3">
                                <div className="min-w-[92vh] bg-white dark:bg-gray-800 shadow-lg rounded-xl p-8">
                                    ...
                                    <input
                                        ...
                                        className="mt-4 mb-4 p-3 border border-gray-300 rounded-lg shadow-lg focus:outline-none focus:ring-2 focus:ring-blue-500 hover:border-blue-500 transition duration-300 bg-white text-gray-700 placeholder-gray-400"
                                    />
                                                ...
                                                <div key={index} className="relative">
                                                    {chart.type === "image" ? (
                                                        <img
                                                            ...
                                                            onClick={() => openModal(chart.content)}
                                                        />
                                                    ) : (
                                                        <a
                                                            href={chart.content}
                                                            ...
                                                            className="block w-full h-48 bg-gray-200 rounded-lg flex items-center justify-center text-center text-blue-600 font-semibold hover:underline"
                                                        >
                                                            View PDF {index + 1}
                                                        </a>
                                                    )}
